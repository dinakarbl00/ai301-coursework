...
I am most comfortable with Python, JavaScript, React, APIs, backend development, and working with data. I have also built AI/ML projects and full-stack applications, so I am comfortable reading an unfamiliar codebase and making focused changes. For a first open-source contribution, I would prefer a clearly bounded bug fix or feature with understandable expected behavior rather than a large refactor or a change deep in framework internals. I also want to get more practice with testing, debugging, and contributing to an existing codebase.
